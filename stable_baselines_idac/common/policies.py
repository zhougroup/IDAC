...
class FeedForwardPolicy(ActorCriticPolicy):
    ...
    def __init__(self, sess, ob_space, ac_space, n_env, n_steps, n_batch, reuse=False, layers=None, net_arch=None, layer_norm=False,
        ...
        with tf.variable_scope("model", reuse=reuse):
            if feature_extraction == "cnn":
                ...
                pi_latent, vf_latent = mlp_extractor(tf.layers.flatten(self.processed_obs), net_arch, act_fun, self.layer_norm)

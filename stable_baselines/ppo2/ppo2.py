...
class PPO2(ActorCriticRLModel):
    ...
    def _train_step(self, learning_rate, cliprange, obs, returns, masks, actions, values, neglogpacs, update,ent_coef,
        ...
        td_map = {self.train_model.obs_ph: obs, self.action_ph: actions,
                  self.advs_ph: advs, self.rewards_ph: returns, self.ent_coef_ph: ent_coef,
    ...
    def learn(self, total_timesteps, callback=None, seed=None, log_interval=1, tb_log_name="PPO2", path = None,
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            d1 = deque(maxlen = 100)
            reward_history, reward_smooth, score_total = [],[],[]
                ...
                if states is None:  # nonrecurrent version
                    ...
                    for epoch_num in range(self.noptepochs):
                        ...
                        for start in range(0, self.n_batch, batch_size):
                            ...
                            mb_loss_vals.append(self._train_step(lr_now, cliprange_now, *slices, writer=writer, ent_coef = ent_now,
                    ...
                    for epoch_num in range(self.noptepochs):
                        ...
                        for start in range(0, self.n_envs, envs_per_batch):
                            ...
                            mb_loss_vals.append(self._train_step(lr_now, cliprange_now, *slices, update=timestep, ent_coef = ent_now,

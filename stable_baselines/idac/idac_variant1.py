...
class IDAC(OffPolicyRLModel):
    ...
    def __init__(self, policy, env, gamma=0.99, learning_rate=3e-4, buffer_size=50000,
                 ...
                 tau=0.005, ent_coef='auto', target_update_interval=1,noise_dim=5,noise_num=1,J=51,K=51,
        ...
        with SetVerbosity(self.verbose):
            ...
            with self.graph.as_default():
                ...
                with tf.variable_scope("loss", reuse=False):
                    ...
                    policy_loss = tf.reduce_mean(self.ent_coef * logp_pi - mean_qf_pi)
    ...
    def _train_step(self, step, writer, learning_rate, dis_eval_array, dis_eval_interval, dis_path):
        ...
        idx = np.arange(0, self.batch_size*(self.J), self.J)
        ...
        obs_tile = np.reshape(np.tile(batch_obs, [1, self.J]), (-1,n_s)) 
